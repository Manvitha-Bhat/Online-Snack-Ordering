   ...
   if(!empty($_SESSION['id']))	
   {
    ...
    if(!empty($chk)) 
	{
		if(empty($img_name))
	       ...
	       {
		          $paymentmode=implode(",",$chk);
	              if(mysqli_query($con,"update  tbfood  set foodname='$food_name',cost='$cost',paymentmode='$paymentmode' where food_id='$food_id'"))
	     ...
	     else
		 {
			     ...
			     echo $paymentmode."<br>";
			     echo $img_name."<br>";
	             if(mysqli_query($con,"update  tbfood  set foodname='$food_name',cost='$cost',paymentmode='$paymentmode', fldimage='$img_name' where food_id='$food_id'"))
