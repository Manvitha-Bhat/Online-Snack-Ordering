...
tblvendor.fld_mob,tblvendor.fld_address,tblvendor.fld_logo,tbfood.food_id,tbfood.foodname,tbfood.cost,tbfood.paymentmode 
...
<body>
	...
	<div id="demo" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="img/savoury-snacks.jpeg" class="d-block w-100">
			...
			<div class="carousel-item">
				<img src="img/bhel.webp" class="d-block w-100">
				<div class="carousel-caption">
					<h3>Order now!</h3>
			...
			<div class="carousel-item">
				<img src="img/snec.webp" class="d-block w-100">
				<div class="carousel-caption">
					<h3>Yummyyy!</h3>
	...
	<div class="container-fluid">
	  ...
	  tblvendor.fld_address,tblvendor.fldvendor_id,tblvendor.fld_logo,tbfood.food_id,tbfood.foodname,tbfood.cost,
	  tbfood.paymentmode,tbfood.fldimage from tblvendor inner join
	...
	<div class="container-fluid">
		<div class="row"><!--main row-->
			...
			<div class="container-fluid rounded" style="border:solid 1px #F0F0F0;"><!--product container-->
					...
					$food_id = $arr[1];
					$query = mysqli_query($con, "select tblvendor.fld_email,tblvendor.fld_name,tblvendor.fld_mob,
	                        tblvendor.fld_address,tblvendor.fld_logo,tbfood.food_id,tbfood.foodname,tbfood.cost,
	                        tbfood.paymentmode,tbfood.fldimage from tblvendor inner join
	                        tbfood on tblvendor.fldvendor_id=tbfood.fldvendor_id where tbfood.food_id='$food_id'");
					while ($res = mysqli_fetch_assoc($query)) {
						$hotel_logo = "image/restaurant/" . $res['fld_email'] . "/" . $res['fld_logo'];
